...
class largerEffNetb0(nn.Module):
    def __init__(self, pitch_class=12, pitch_octave=4):
        super(largerEffNetb0, self).__init__()
        ...
        self.effnet.conv_stem = nn.Sequential(nn.Conv2d(1, 16, kernel_size=(7, 7), stride=(2, 1), padding=(6, 3)),
                                             nn.ReLU(),
